...
export default function Slide2({ handleNext, quotation, setQuotation }: any) {
    const {
        register,
        handleSubmit,
        formState: { errors },
                ...
                <TopToBottomFramer>
                    <div className="flex gap-x-2 font-AvenirMedium text-2xl lg:text-4xl">
                        <p className="flex h-min items-center gap-x-2">
                            1 <HiArrowRight size={16} />
                        </p>
                        <form onSubmit={handleSubmit(onSubmit)} className="flex-1">
                            <p>Let's start with your good name.</p>
                            <input
                            ...
                            {errors.Name ? (
                                <div className="mt-4 flex w-fit items-center gap-x-1 bg-red-100 px-4 py-1 text-base text-red-800">
                                    <HiExclamation size={18} /> This field is required
                                </div>
                            ) : (
