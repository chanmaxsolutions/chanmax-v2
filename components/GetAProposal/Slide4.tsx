...
export default function Slide4({ handleNext, quotation, setQuotation }: any) {
    const {
        register,
        handleSubmit,
        formState: { errors },
                ...
                <TopToBottomFramer>
                    <div className="flex gap-x-2 font-AvenirMedium text-2xl lg:text-4xl">
                        <p className="flex h-min items-center gap-x-2">
                            3 <HiArrowRight size={16} />
                        </p>
                        <form onSubmit={handleSubmit(onSubmit)} className="flex-1">
                            <p>That's awesome,{quotation.Name || "___"}, and what's your company name?</p>
                            <input
                                {...register("Company", { required: true })}
                                placeholder="EX: Chanmax"
